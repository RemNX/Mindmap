...
\node {Chapitre 1: Equation d'Euler}
    ...
    child [rotate=-10]{ node {Théorème de bernoullie}
    ...
    child [rotate=-15]{ node {Ecoulement potentiel}
    ...
    child [rotate=-7]{ node {Tourbillon et Vortex}
        child[concept,rotate=-10]{node[concept,text width=7em]{Théorème de Kelvin $\Gamma = \oint_{C(t)}\vec{v}.\vec{dl}$}
        }
        child[concept]{node[concept,text width=7em]{Théorème de Helmotz $T=\int_S \vec{\omega}\vec{dS}$}
        }
    }
